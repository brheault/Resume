...
\begin{center}
    ...
    \vspace{2pt}
    (786)-728-7149 | \href{mailto:brheault@ufl.edu}{brheault@ufl.edu} | Gainesville, FL
\end{center}

\section{EDUCATION}
\noindent \textbf{University of Florida - Herbert Wertheim College of Engineering} \hfill Gainesville, FL \\
\noindent \textit{Doctor of Philosophy in Computer Science} (GPA: 3.80) \hfill Expected Spring 2027 \\
\noindent \textit{Master of Science in Computer Science} (GPA: 3.80) \hfill 2025 \\
\noindent \textit{Bachelor of Science in Computer Science, Minor in Digital Arts} (GPA: 3.96) \hfill 2022 \\
...
\noindent \textbf{Graduate Research Assistant} \hfill Aug 2022 -- Dec 2024 \\
...
\begin{itemize}
    ...
    \item \textbf{User Modeling:} Led a 50-participant study collecting biometric data under stress. Trained ML models (Neural Networks, Decision Trees) achieving \textbf{98\% accuracy} in predicting stress states.
    ...
    \item \textbf{Rendering Study (Ongoing):} Investigating the impact of CT scan rendering styles on structural comprehension, comparing VR environments to traditional 2D monitors.
\end{itemize}
...
\noindent \textbf{Graduate Teaching Assistant} \hfill Jan 2025 -- Present \\
...
\begin{itemize}
    ...
    \item Manage a team of undergraduate TAs; oversee grading, office hours, and curriculum support for high-enrollment courses.
\end{itemize}

\noindent \textbf{Undergraduate Teaching Assistant} \hfill Aug 2019 -- May 2021 \\
